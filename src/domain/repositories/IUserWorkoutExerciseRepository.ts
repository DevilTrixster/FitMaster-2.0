...
export interface IUserWorkoutExerciseRepository {
    ...
    findByPlannedExercise(userWorkoutId: number, plannedExerciseId: number): Promise<UserWorkoutExercise | null>;
    create(userWorkoutExercise: UserWorkoutExercise): Promise<UserWorkoutExercise>;
    update(userWorkoutExercise: UserWorkoutExercise): Promise<UserWorkoutExercise>;
}